...
namespace SalaryCalculation.Tests
{
    public class CalcualtionsTests
    {
        ...
        public void TestMetrics1()
        {
            ...
            Assert.Equal(230.45, Math.Round(metrics.HourCostFact,2));
            Assert.Equal(125.0, Math.Round(metrics.HourCostHand,2));
            Assert.Equal(54133.33, Math.Round(metrics.Income,2));
            ...
            Assert.Equal(23000, Math.Round(metrics.SalaryBeforeTax,2));
            Assert.Equal(20010, Math.Round(metrics.SalaryAftertax,2));
        }
        ...
        public void TestMetrics2()
        {
            ...
            Assert.Equal(119.26, Math.Round(metrics.HourCostFact,2));
            Assert.Equal(62.50, Math.Round(metrics.HourCostHand,2));
            Assert.Equal(27066.67, Math.Round(metrics.Income,2));
            ...
            Assert.Equal(11500, Math.Round(metrics.SalaryBeforeTax,2));
            Assert.Equal(10005, Math.Round(metrics.SalaryAftertax,2));
        }
        ...
        public void TestMetrics3()
        {
            ...
            Assert.Equal(34.68, Math.Round(metrics.HourCostFact,2));
            Assert.Equal(0.01, Math.Round(metrics.HourCostHand, 2));
            Assert.Equal(54133.33, Math.Round(metrics.Income, 2));
            ...
            Assert.Equal(1.15, Math.Round(metrics.SalaryBeforeTax,2));
            Assert.Equal(1, Math.Round(metrics.SalaryAftertax,2));
        }
        ...
        public void TestMetrics4()
        {
            ...
            Assert.Equal(34.67, Math.Round(metrics.HourCostFact, 2));
            Assert.Equal(0, Math.Round(metrics.HourCostHand, 2));
            Assert.Equal(54133.33, Math.Round(metrics.Income, 2));
